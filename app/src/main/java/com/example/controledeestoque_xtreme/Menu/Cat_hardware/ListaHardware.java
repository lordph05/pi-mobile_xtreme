...
//        ibAdd = findViewById(R.id.ib_add);
   ...
   public void beforeTextChanged(CharSequence var1, int var2, int var3, int var4) {
    ...
    public void afterTextChanged(Editable text){
        ...
        ArrayList <Produtos> listaProdutos = listaHardwareAdapter_.hardwareList;
        ...
        ib_voltar_inicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userLogado.perfil.equals("admin")){
                    startActivity(new Intent(ListaHardware.this, MenuAdmin.class));
                }else {
                    startActivity(new Intent(ListaHardware.this, MenuFuncionario.class));
                }
            }
        });
    ...
    private void configRecyclerView (){
        ...
        rvProdutos.setListener(new SwipeLeftRightCallback.Listener() {
            ...
            public void onSwipedRight(int position) { // removendo os itens da lista
                ...
                Produtos produto = listaHardwareAdapter_.hardwareList.get(position);
