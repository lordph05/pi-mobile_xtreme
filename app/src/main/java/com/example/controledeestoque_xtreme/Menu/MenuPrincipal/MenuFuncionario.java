...
public class MenuFuncionario extends AppCompatActivity {
    ...
    private Button btn_hardware, btn_perifericos, btn_redes_conectividade,btn_sair,btn_computadores,btn_add_produto;
    ...
    private void configClique() { // eventos de cliques fora da origem.
        ...
        btn_add_produto.setOnClickListener(view -> startActivity(new Intent(this, ListaHardwareAdd.class)));
